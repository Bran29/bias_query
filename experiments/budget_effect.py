...
if __name__ == "__main__":
    ...
    for kk in range(0, 3):
        ...
        budget = 0.1 * D_provider_x[0].shape[0]
        ...
        np.save(
            "record/budget_unbias_test_accuracy_before_off" + str(kk) + ".npy",
            np.array(test_accuracy_before),
        )
        np.save(
            "record/budget_unbias_test_dp_before_off" + str(kk) + ".npy",
            np.array(test_dp_before),
        )
        np.save(
            "record/budget_unbias_test_accuracy_after_off" + str(kk) + ".npy",
            np.array(test_accuracy_after),
        )
        np.save(
            "record/budget_unbias_test_dp_after_off" + str(kk) + ".npy",
